                ...
                <?php 
                    ...
                    if (isset($_SESSION['pelanggan'])) {
                       echo '
                            ...
                            <div class="float-end me-4 mt-4">Pelanggan : <a href="?f=home&m=beli"> '. $_SESSION['pelanggan'] .' </a> </div>
                       ...
                       ';
                        ...
                        echo '
                            <div class="float-end me-4 mt-4"><a href="?f=home&m=login">Login</a></div>
                            <div class="float-end me-4 mt-4"><a href="?f=home&m=daftar">Daftar</a></div>
